...
Future<CreateReportResponse> createFeedbck(SendReportBody body) async {
    final response = await post(
        baseUrl+"feedback/feedback",headers: {"Content-Type": "application/json"},
        body:json.encode({"name":body.name,"email":body.email.toString(),
        "content":body.content,
        "subject":body.subject,"phone":body.phone,"location":body.location}));
...
CreateReportResponse createReportResponseFromJson(String str) => CreateReportResponse.fromJson(json.decode(str));
